...
def csv_upgrade(current_version, new_version):
    current_csv = "./manifests/devconsole/" + current_version + "/devconsole-operator.v" + current_version + ".clusterserviceversion"
    new_csv = "./manifests/devconsole/" + new_version + "/devconsole-operator.v" + new_version + ".clusterserviceversion"
